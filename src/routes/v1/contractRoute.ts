...
router.post(
	...
	catchAsync(templateController.createFromTemplate)
);
...
router.get(
	'/:id/download',
	authenticate(),
	validate(contractValidation.downloadContract),
	catchAsync(contractController.downloadContract)
);
router.patch(
	'/:id/favorite',
	authenticate(),
	validate(contractValidation.favoriteContract),
	catchAsync(contractController.favoriteContract)
);
router.patch(
	'/:id/unfavorite',
	authenticate(),
	validate(contractValidation.favoriteContract),
	catchAsync(contractController.unfavoriteContract)
);
