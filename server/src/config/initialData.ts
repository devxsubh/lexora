					...
					content: [
						{
							...
							type: 'heading',
							props: { level: 1 },
							content: [{ type: 'text', text: 'Mutual Non-Disclosure Agreement', styles: {} }]
						},
						{
							id: 't2',
							type: 'paragraph',
							...
							content: [
								{
									type: 'text',
									text: 'This Mutual Non-Disclosure Agreement ("Agreement") is entered into as of {{Effective Date}} by and between {{Party A Name}} ("Party A") and {{Party B Name}} ("Party B").',
									styles: {}
								}
							]
						},
						{
							...
							type: 'heading',
							props: { level: 2 },
							content: [{ type: 'text', text: '1. Definition of Confidential Information', styles: {} }]
						},
						{
							id: 't4',
							type: 'paragraph',
							...
							content: [
								{
									type: 'text',
									text: '"Confidential Information" means any non-public information disclosed by either party to the other party, whether orally, in writing, or by inspection of tangible objects.',
									styles: {}
								}
							]
						},
						{
							...
							type: 'heading',
							props: { level: 2 },
							content: [{ type: 'text', text: '2. Obligations of Receiving Party', styles: {} }]
						},
						{
							id: 't6',
							type: 'paragraph',
							...
							content: [
								{
									type: 'text',
									text: 'The Receiving Party shall hold and maintain the Confidential Information in strict confidence and shall not disclose, publish, or otherwise reveal any of the Confidential Information to any third party.',
									styles: {}
								}
							]
						},
						{ id: 't7', type: 'heading', props: { level: 2 }, content: [{ type: 'text', text: '3. Term', styles: {} }] },
						{
							...
							content: [
								{
									type: 'text',
									text: 'This Agreement shall remain in effect for a period of three (3) years from the Effective Date.',
									styles: {}
								}
							]
						}
					...
					content: [
						{ id: 'v1', type: 'heading', props: { level: 1 }, content: [{ type: 'text', text: 'Vendor Agreement', styles: {} }] },
						{
							...
							content: [
								{
									type: 'text',
									text: 'This Vendor Agreement ("Agreement") is entered into as of {{Effective Date}} by and between {{Company Name}} ("Company") and {{Vendor Name}} ("Vendor").',
									styles: {}
								}
							]
						},
						{
							...
							type: 'heading',
							props: { level: 2 },
							content: [{ type: 'text', text: '1. Scope of Services', styles: {} }]
						},
						{
							id: 'v4',
							type: 'paragraph',
							...
							content: [
								{
									type: 'text',
									text: 'Vendor agrees to provide the services described in Exhibit A attached hereto.',
									styles: {}
								}
							]
						}
					...
					content: [
						{
							...
							type: 'heading',
							props: { level: 1 },
							content: [{ type: 'text', text: 'Consulting Agreement', styles: {} }]
						},
						{
							id: 'c2',
							type: 'paragraph',
							...
							content: [
								{
									type: 'text',
									text: 'This Consulting Agreement ("Agreement") is entered into as of {{Effective Date}} by and between {{Client Name}} ("Client") and {{Consultant Name}} ("Consultant").',
									styles: {}
								}
							]
						}
					...
					content: [
						{
							...
							type: 'heading',
							props: { level: 1 },
							content: [{ type: 'text', text: 'Employment Offer Letter', styles: {} }]
						},
						{ id: 'e2', type: 'paragraph', props: {}, content: [{ type: 'text', text: 'Dear {{Candidate Name}},', styles: {} }] },
						{
							...
							content: [
								{
									type: 'text',
									text: 'We are pleased to offer you the position of {{Job Title}} at {{Company Name}}, effective {{Start Date}}.',
									styles: {}
								}
							]
						}
					...
					content: [
						{
							...
							type: 'heading',
							props: { level: 1 },
							content: [{ type: 'text', text: 'Master Service Agreement – Logistics', styles: {} }]
						},
						{
							id: 'm2',
							type: 'paragraph',
							...
							content: [
								{
									type: 'text',
									text: 'This Master Service Agreement ("Agreement") is entered into as of {{Effective Date}} by and between {{Company Name}} ("Company") and {{Logistics Partner}} ("Partner").',
									styles: {}
								}
							]
						}
			...
			await Clause.insertMany([
				{
					...
					content:
						'Both parties agree to maintain the confidentiality of all proprietary information shared under this Agreement for a period of three (3) years after termination.',
					category: 'Confidentiality',
					tags: ['nda', 'mutual'],
					usageCount: 24
				},
				{
					...
					content:
						"Except as required by law, each party's aggregate liability shall be limited to the fees paid under this Agreement in the twelve (12) months preceding the claim.",
					category: 'Liability',
					tags: ['cap', 'commercial'],
					usageCount: 17
				},
				...
				},
				{
					...
					content:
						'This Agreement shall be governed by and construed in accordance with the laws of India and the courts at New Delhi shall have exclusive jurisdiction.',
				...
				},
				{
					...
					content:
						'Any dispute arising out of or in connection with this Agreement shall be finally settled by binding arbitration in accordance with the rules of the chosen arbitration institution.',
